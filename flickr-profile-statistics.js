...
(() => {
    ...
    const profilePages = [
        'cameraroll-page-view',
        'photostream-page-view',
        'albums-list-page-view',
        'favorites-page-view',
        'groups-list-view'
    ];
    ...
    function isProfilePage() {
        for (var i = 0; i < profilePages.length; i++ ) {
            if ($('.view').hasClass(profilePages[i])) {
                return true;
            }
        }
    ...
    function showData(data) {
        ...
        var divFollowers = $('p.followers');
        var divMoreStats = $('<p class="truncate" style="max-width: 600px;float: left;"></p>');
        ...
        divMoreStats.append('<em>•</em><a href="">' + totalView + ' views</a>');
        divMoreStats.append('<em>•</em><a href="">' + totalFav + ' favorites</a>');
        divMoreStats.append('<em>•</em><a href="">' + totalComm + ' comments</a>');

        divFollowers.after(divMoreStats);
    };
    ...
    function getStat() {
        var checkConfig = setInterval(function() {
            ...
            if ($('p.followers').length === 0 || !isProfilePage()) {
                return;
            }
